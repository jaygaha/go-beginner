...
func (ec *executionContext) field_Mutation_addBook_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewBook2githubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐNewBook(ctx, tmp)
	}
...
func (ec *executionContext) fieldContext_Book_published(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Book",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Mutation_addBook(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddBook(rctx, fc.Args["input"].(model.NewBook))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNBook2ᚖgithubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_books(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Book)
	fc.Result = res
	return ec.marshalNBook2ᚕᚖgithubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBookᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNBook2githubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v model.Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚕᚖgithubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖgithubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewBook2githubᚗcomᚋjaygahaᚋgoᚑbeginnerᚋcmdᚋ20_web_frameworksᚋgqlgenᚋgraphᚋmodelᚐNewBook(ctx context.Context, v any) (model.NewBook, error) {
