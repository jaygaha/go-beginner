...
type HelloRequest struct {
	...
	Locale        string                 `protobuf:"bytes,1,opt,name=locale,proto3" json:"locale,omitempty"` // e.g. "en", "jp", "fr", etc.
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`     // Name to include in the greeting.
...
const file_proto_greet_proto_rawDesc = "" +
	"\n" +
	"\x11proto/greet.proto\x12\x05greet\x1a\x1cgoogle/api/annotations.proto\":\n" +
	...
	"\fGreetService\x12N\n" +
	"\x0eTranslateHello\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReply\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/greetBYZWgithub.com/jaygaha/go-beginner/cmd/22_microservices/22_6_gRPC-gateway/proto/greet_protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetService.TranslateHello:input_type -> greet.HelloRequest
	1, // 1: greet.GreetService.TranslateHello:output_type -> greet.HelloReply
